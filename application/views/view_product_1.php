...
<div class="container">
    ...
    if($this->model_product->get_product_by_id($id)){
        ...
        $product_info=$this->model_product->get_product_by_id($id);
            ...
            ?>
<!--heading--> 
    <div class="col-lg-12 border-style" style="">
        <h1> <?php echo $product_info['title'] ; ?></h1>
    </div>
    ...
    <div class="">
       ...
       <!--content-->
        <div class="col-lg-4 " style=" float: right;">
            <!--description--> 
            <div class=" border-style" style="height :150px; margin: 14px -15px;"> 
                <p style="    padding: 21px; text-align: center"> 
                    <?php echo $product_info['description'] ; ?>
                </p>
            </div>
            <!--price-->
            <div class=" border-style" style="height :150px; margin: 14px -15px;">
                <p style="padding: 11px;">Price for the item</p>
                <h1 style="text-align: center;"> Rs : <?php echo $product_info['price'] ; ?></h1>
            </div>
            <!--add to cart-->
            <div class="border-style" style="height :150px; margin: 14px -15px;sssss"> 
                <p style="padding: 24px;">ns nic ununciec ineiecien ncencien ncnicn iencnec nicnc </p>
