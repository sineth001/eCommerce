    ...
    <div class=" row" >  
        ...
        <div class="flex-container">
            <div class="flex-item1" >
                ...
                <a href="<?php echo site_url('late_payment/pay/ezcash'); ?>" class="btn btn_goback" style="width: 100%;margin: 0px;"> Pay now</a>
            </div>
            <div class="flex-item1" >
                ...
                <a href="<?php echo site_url('late_payment/pay/mcash'); ?>" class="btn btn_goback" style="width: 100%;margin: 0px;"> Pay now</a>
            </div>
            <div class="flex-item1" >
                ...
                <a href="<?php echo site_url('late_payment/pay/webxpay'); ?>" class="btn btn_goback" style="width: 100%;margin: 0px;"> Pay now</a>
            </div>
            <div class="flex-item1" >
                ...
                <a href="<?php echo site_url('late_payment/pay/checkout'); ?>" class="btn btn_goback" style="width: 100%;margin: 0px;"> Pay now</a>
            </div>
        </div> 
    </div>
