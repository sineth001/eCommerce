...
<div class=" container body-wrapper">
    ...
    if($this->model_welcome->get_package_info_by_user_id()){
                      ...
                      if(empty($user_package_info['payment'])&&$user_package_info['payment']!=1){
                        echo '<div class="row" style=" height: 150px ; background-color: #d5ebed">';

                        echo '<div class=" " style="  text-align: center; padding: 44px 0px;">';

            
                  
                          echo '<a href='.  site_url("late_payment/index/".$package_info['id']."/".$package_info['pack_name']."/".$package_info['initial_payment'])
                                  .' class="btn btn btn_submit" style="padding: 19px 54px;"><i class="fa fa-money" aria-hidden="true" style="padding: 2px 10px;"> Pay now</a>';
